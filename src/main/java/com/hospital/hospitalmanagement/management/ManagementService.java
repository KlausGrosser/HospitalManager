...
// create a confirmation link to be sent to the user email
    ...
    public String updateDoctor(ManagementRequest request) {
        if(!doctorService.findDoctorByEmail(request.getEmail())){
            return register(request);
        }

        String token = doctorService.updateDoctor(new Doctor(request.getFirstName(),
                request.getLastName(),
                request.getEmail(),
                request.getPassword(),
                request.getDoctorRole(),
        ...
        String link = "http://localhost:8051/api/v1/doctor/update/confirm?token=" + token;
        //Send Email
        emailSender.send(
                request.getEmail(),
                buildUpdateEmail(request.getFirstName(),link)
        );
        return token;
    }
    ...
    private String buildUpdateEmail(String name, String link) {
        return "\"<div style=\\\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\\\">\\n\" +\n" +
                "        \"\\n\" +\n" +
                "        \"<span style=\\\"display:none;font-size:1px;color:#fff;max-height:0\\\"></span>\\n\" +\n" +
                "        \"\\n\" +\n" +
                ...
                "        \"                    </td>\\n\" +\n" +
                "        \"                    <td style=\\\"font-size:28px;line-height:1.315789474;Margin-top:4px;padding-left:10px\\\">\\n\" +\n" +
                "        \"                      <span style=\\\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\\\">Update your Information</span>\\n\" +\n" +
                "        \"                    </td>\\n\" +\n" +
                "        \"                  </tr>\\n\" +\n" +
                "        \"                </tbody></table>\\n\" +\n" +
                "        \"              </a>\\n\" +\n" +
                ...
                "        \"      <td style=\\\"font-family:Helvetica,Arial,sans-serif;font-size:19px;line-height:1.315789474;max-width:560px\\\">\\n\" +\n" +
                "        \"        \\n\" +\n" +
                "        \"            <p style=\\\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\\\">Hi \" + name + \",</p><p style=\\\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\\\"> You indicated you wanted to update your information, click this link to be taken to a form that will update everything you want to update!  </p><blockquote style=\\\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\\\"><p style=\\\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\\\"> <a href=\\\"\" + link + \"\\\">Update</a> </p></blockquote>\\n Link will expire in 15 minutes. <p>See you soon</p>\" +\n" +
                "        \"        \\n\" +\n" +
                "        \"      </td>\\n\" +\n" +
                "        \"      <td width=\\\"10\\\" valign=\\\"middle\\\"><br></td>\\n\" +\n" +
                "        \"    </tr>\\n\" +\n" +
